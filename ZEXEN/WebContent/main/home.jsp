...
<body>
  <main class="site-main">
    ...
    ================ Hero banner start =================<br>

    ================ Hero Carousel start =================<br>
    ...
    ================ Hero Carousel end =================<br>

    ================ trending product section start =================  <br>
    ...
    ================ trending product section end =================  <br>


    ================ offer section start ================= <br>
    ...
    ================ offer section end ================= <br>

    ================ Best Selling item  carousel ================= <br>
    <section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          <p>Popular Item in the market</p>
    ...
    ================ Best Selling item  carousel end ================= <br>

    ================ Blog section start =================  <br>
    <section class="blog">
      <div class="container">
        <div class="section-intro pb-60px">
          <p>Popular Item in the market</p>
